...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "OctoKit", url: "https://github.com/nerdishbynature/octokit.swift", from: "0.10.1"),
        // Dev dependencies
        ...
        .package(url: "https://github.com/SwiftDocOrg/swift-doc", .branch("1.0.0-beta.4")),
    ],
    targets: [
