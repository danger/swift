...
public struct GitLab: Decodable {
    ...
    public let mergeRequest: Danger.GitLabMergeRequest

    public let metadata: Danger.GitLabMetadata
}
...
public struct GitLabMergeRequest: Decodable, Equatable {
    ...
    public struct Milestone: Decodable, Equatable {
        ...
        public let state: Danger.GitLabMergeRequest.Milestone.State
    ...
    public struct Pipeline: Decodable, Equatable {
        ...
        public let status: Danger.GitLabMergeRequest.Pipeline.Status
    ...
    public let assignee: Danger.GitLabUser?

    public let author: Danger.GitLabUser

    public let changesCount: String

    public let closedAt: Date?

    public let closedBy: Danger.GitLabUser?

    public let description: String

    public let diffRefs: Danger.GitLabMergeRequest.DiffRefs
    ...
    public let mergedBy: Danger.GitLabUser?
    ...
    public let state: Danger.GitLabMergeRequest.State
    ...
    public let timeStats: Danger.GitLabMergeRequest.TimeStats
...
public struct GitLabUser: Decodable, Equatable {
    ...
    public let state: Danger.GitLabUser.State
