...
extension GitLab {
    public struct MergeRequest: Decodable, Equatable {
        ...
        public struct Milestone: Decodable, Equatable {
            ...
            public let iid: Int
            /// Will has value if it is a regular \
            /// [project milestone](https://docs.gitlab.com/ee/api/milestones.html). Or it will be nil.
            public let projectId: Int?
            /// Will has value if it is a \
            /// [group milestone](https://docs.gitlab.com/ee/api/group_milestones.html). Or it will be nil.
